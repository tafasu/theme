function runScroll(){scrollTo(document.body,0,200);}
var scrollme;scrollme=document.querySelector("#ai-chan-to-top");scrollme.addEventListener("click",runScroll,false)
